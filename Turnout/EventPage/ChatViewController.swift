...
//  Turnout
//
//  Created by Mobile World on 12/2/17.
...
final class ChatViewController: JSQMessagesViewController {
    ...
    override func viewDidLoad() {
        ...
        let myNewView=UIView(frame: CGRect(x: 0, y: 0, width: width, height: 128))
        
        // Add UIView as a Subview
        self.view.addSubview(myNewView)
        myNewView.addSubview(titleView)
        
        titleLabel.text = Globals.name
        titleView.backgroundColor = UIColorFromRGB(rgbValue: 0xa459fc)
        collectionView.backgroundColor = UIColorFromRGB(rgbValue: 0xa459fc)
    }
...
//        }
    ...
    private func setupOutgoingBubble() -> JSQMessagesBubbleImage {
        ...
        return bubbleImageFactory!.outgoingMessagesBubbleImage(with: UIColorFromRGB(rgbValue: 0x992ff6))
    }
    
    private func setupIncomingBubble() -> JSQMessagesBubbleImage {
        let bubbleImageFactory = JSQMessagesBubbleImageFactory()
        return bubbleImageFactory!.incomingMessagesBubbleImage(with: UIColorFromRGB(rgbValue: 0x803fcd))
    }
